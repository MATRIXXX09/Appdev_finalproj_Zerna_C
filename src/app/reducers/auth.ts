import { ReduxAction, AuthState, AuthData } from '../../types';
import {
  USER_LOGIN,
...
export default function reducer(state: AuthState = INITIAL_STATE, action: ReduxAction): AuthState {
  ...
  switch (action.type) {
    ...
    case USER_LOGIN_COMPLETED:
      ...
      return {
        ...state,
        data: action.payload as AuthData,
        isLoading: false,
        isError: false,
        errorMessage: null,
      };
